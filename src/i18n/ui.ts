...
export const ui = {
  en: {
    // Site Metadata
    "siteMetadata.title": "Jose Iciano's Blog",
    "siteMetadata.headerTitle": "Jose Iciano's Blog",
    "siteMetadata.description": "Jose Iciano's Blog. Part of personal website.",
    "siteMetadata.language": "en-US",

    // Pages
    "pages.home.latestPosts": "Latest posts",
    "pages.home.viewAllPosts": "View all posts",
    "pages.home.noPosts": "No posts found...yet",
    ...
    "components.socialShareButtons.sharing": "Share the Love!",
